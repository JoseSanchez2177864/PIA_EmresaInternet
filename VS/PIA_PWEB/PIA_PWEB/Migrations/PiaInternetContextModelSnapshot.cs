...
namespace PIA_PWEB.Migrations
{
    ...
    partial class PiaInternetContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PIA_PWEB.Models.dbModels.DetalleVenta", b =>
                {
            ...
            modelBuilder.Entity("PIA_PWEB.Models.dbModels.Opinione", b =>
                {
            ...
            modelBuilder.Entity("PIA_PWEB.Models.dbModels.Paquete", b =>
                {
                    b.Property<int>("IdPaquete")
                        .HasColumnType("int")
                        .HasColumnName("idPaquete");
            ...
            modelBuilder.Entity("PIA_PWEB.Models.dbModels.Venta", b =>
                {
                    b.Property<int>("IdVenta")
                        .HasColumnType("int")
                        .HasColumnName("idVenta");
            ...
            modelBuilder.Entity("PIA_PWEB.Models.dbModels.DetalleVenta", b =>
                {
                    b.HasOne("PIA_PWEB.Models.dbModels.Paquete", "IdPaqueteNavigation")
                        .WithMany("DetalleVenta")
                        .HasForeignKey("IdPaquete")
                        .IsRequired()
                        .HasConstraintName("FK__DetalleVe__idPaq__4222D4EF");

                    b.HasOne("PIA_PWEB.Models.dbModels.Venta", "IdVentaNavigation")
                        .WithMany("DetalleVenta")
